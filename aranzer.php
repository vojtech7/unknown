...
<body>
  ...
  <?php  
    ...
    $skladba["tabulka_upravy"] = "Skladba";
      ...
      echo "</div>";
        ...
        *************************************/
        ...
        if ($_GET["edit_skladba"]=="edit") {
              ...
              $ID_autora=$cislo[0];
              $sql = "UPDATE {$skladba['tabulka_upravy']} 
        ...
        elseif ($_GET["edit_skladba"]=="add") {
            $sql = "SELECT max(ID_skladby) FROM  {$skladba['tabulka_upravy']} ;";
            ...
            $insert_row = "INSERT INTO {$skladba['tabulka_upravy']} 
        ...
        ************************************************/
        ...
        if ($_GET["edit_autor"]=="edit") {
              ...
              $sql = "UPDATE {$autor['tabulka_upravy']} 
        ...
        elseif ($_GET["edit_autor"]=="add") {
          ...
          $insert_row = "INSERT INTO {$autor['tabulka_upravy']} 
